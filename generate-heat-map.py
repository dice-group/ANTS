...
def collate_idf(arr, tokenize, numericalize, idf_dict,
    ...
    tokens = [truncate(tokenize(a)) for a in arr]  
...
def plot_example(is_flow, reference, translation, device='cuda:0'):
    ...
    fig, ax = plt.subplots(figsize=(len(r_tokens)*0.3, len(h_tokens)*0.3))
    ...
    plt.xlabel("System Output", fontsize=12)
    plt.ylabel("ESSUM Dataset", fontsize=12)
    plt.title("Flow Matrix", fontsize=13)
    ...
    plt.savefig("small_flow_matrix.png", dpi=400, bbox_inches='tight')  # Avoid bbox_inches='tight' if it causes issues
    plt.show()  # Ensure the plot is displayed before closing

reference = '3WAY FM (ACMA callsign: 3WAY) is an Australian community radio station based in Warrnambool, Victoria. Established in 1990, it broadcasts on frequency 103.7 FM and is a member of the Community Broadcasting Association of Australia.TOM AND ALEX'
translation = 'The 3WAY FM is a community radio station in Warrnambool, Australia. It was founded in 1982 and is operated by the Portland Community Broadcasting Society. Its location is in the city of Warrnambool, Australia. It broadcasts the 3way fm. The Australian Broadcasting Society is the owner of the 3WAY fm.'

#reference = "The 2011 Sparta Prague Open was a professional tennis tournament played on clay courts . It was part of the 2011 ITF Women ' s Circuit , offering a total of $ 100,000 in prize money . It took place at the Tennis Club Sparta Prague in Bubeneč , Prague , Czech Republic , from 9 to 15 May 2011."
#translation = "The 2011 Sparta Prague Open is located in Prague , Czech Republic and was champion by Petra Cetkovská and Michaela krajicek . It is a tennis tournament and plays at the hampden park . The 2011 Sparta Prague open has a tenant called TK Sparta Praha and their surface is made of clay ."
